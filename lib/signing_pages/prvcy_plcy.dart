...
class _PrivacyPolicyState extends ConsumerState<PrivacyPolicy> {
  ...
  Widget build(BuildContext context) {
    ...
    final isInitReg = ref.watch(regStateNotifierProvider);
                            ...
                            style:
                                Theme.of(context).textTheme.bodySmall?.copyWith(
                                      ...
                                      fontSize: isSmallScreen
                                          ? 16.0
                                          : 16.0, // I want to make it uniform
                                    )
                            // style: TextStyle(
                            //     height: 2,
                            //     fontSize: 16.0,
                        ...
                        if (_buttonText == 'Continue') {
                          ...
                          if (isInitReg) {
                            kIsWeb
                                ...
                                : GoRouter.of(context)
                                    .push('/sign-up-opt'); //'/sign-up');
                            //  kIsWeb
                            //     ? context.go('/id-processing')
                            //     : GoRouter.of(context).push(
                            //         Uri(path: '/id-processing') // you can remove URI here, except the path argument
                            //             .toString()); //'/sign-up'); // for testing purposes
                          } else {
                            GoRouter.of(context).push('/id-processing');
                          }
                        }
                      },
                    ),
